...
const timeWib = moment.tz('Asia/Jakarta').format('DD/MM')
		...
		const floc = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `{setting.owner}`,jpegThumbnail: fs.readFileSync('./media/ganteng.jpg')}}}
// stickwm
...
┃│
┃╰──[ B O T - T O L O L ]──⃞⃟⃞⃟
┗━━━━━━━━━━━━━━━━━━━⃞⃟⃞⃟⃞⃟

┏━━━━━━━━━━━━━━━━━━━⃞⃟⃞⃟⃞⃟
┃┌───[  INFO BOT  ]──⃞⃟⃞⃟
┃│_❑  Nama :* Xyeenza CPH77
┃│_❑  Nomor :* @6281227836707
┃│_❑  Owner :* @6281227836734
┃│_❑  Aktif :* ${runtime(process.uptime())}
┃│_❑  Baterai :* ${baterai}%
┃│_❑  Prefix :* 『 ${prefix} 』
┃│
┃╰──[ B O T - T O L O L ]──⃞⃟⃞⃟
...
┗━━━━━━━━━━━━━━━━━━━⃞⃟⃞⃟⃞⃟
*Apa Bang Ga Trima??
*Chat wa.me/6281227836734`
               buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: 'OWNER'},type:1},{buttonId: `${prefix}infoig`,buttonText:{displayText: 'INSTAGRAM'},type:1},{buttonId:`${prefix}command`,buttonText:{displayText:'SIMPLE MENU'},type:1}]
...
*Cek list Server GTIVD dibawah!*`
        ...
        case 'command':
               ...
               listmenuu = [`Menu Group`,`Wibu Menu`,`Sticker Menu`,`Islam Menu`,`Serti Menu`,`Cerita Menu`,`Maker Menu`,`Dewasa Menu`,`Owner Menu`,`Game Menu`,`Fun Menu`,`Downloader`,`MenuLainnya`,`Tools Menu`]
               nombor = 1
               startnum = 0
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt ZakiR HoriZontaL\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI ZakiR HoriZontaL\`\`\`')
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`ZakiR HoriZontaL ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
"groupName": `ZakiR HoriZontaL ~ 404 ${vipi}`,
...
"title": `ZakiR HoriZontaL ~ 404 ${vipi}`,
"description": `${virtex}`,
"currencyCode": "IDR",
...
//------------------< Menunya Bang:v >-------------------              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://instagram.com/m.xzkr_`)
             break
      case 'ownermenu':
